...
import com.gaurang.blog.website.services.EmailService;
...
import com.gaurang.blog.website.util.AppUtil;
import com.gaurang.blog.website.util.email.EmailDetails;
...
public class AccountController {
    ...
    public String register_user(@Valid @ModelAttribute Account account,RedirectAttributes attributes, BindingResult result) throws Exception {
        Optional<Account> existiingAcc = accountService.findOneByEmail(account.getEmail());
        if (result.hasErrors()) {
            return "account_views/register";
        }
        if(existiingAcc.isPresent()){
